...
export default function FuneralServicesSection() {
  return (
    <div className="bg-gray-100 py-8 sm:py-12 md:py-16 px-4">
      <div className="relative z-10 max-w-7xl mx-auto pl-4 sm:pl-6 md:pl-10 pr-4 sm:pr-6 md:pr-8">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          <div>
            ...
            <p className="text-sm sm:text-base text-gray-600 max-w-xl mb-6 sm:mb-8 leading-relaxed">
            ...
            <Link to='/contact'>
              <button className="bg-[#09a3db] text-white font-semibold py-3 px-6 rounded-full transition-all duration-300 flex items-center hover:bg-blue-700 text-sm">
                Contact us
              </button>
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            ...
            <div className="bg-[#09a3db] rounded-lg p-6 sm:p-8 text-center hover:shadow-xl transition-all duration-300 flex flex-col items-center justify-center">
              <div className="text-white mb-3 sm:mb-4">
                <svg className="w-10 h-10 sm:w-12 sm:h-12 mx-auto" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="bg-white rounded-lg p-6 text-center hover:shadow-xl transition-all duration-300 flex flex-col items-center justify-center border border-gray-200">
              <div className="text-[#09a3db] mb-3">
