        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div>
            <div className="inline-block">
              <div className="text-[#0f3b66] text-sm font-semibold mb-4 flex items-center">
                <span className="inline-block w-8 h-0.5 bg-[#0f3b66] mr-3"></span>
                WHY CHOOSE US
              </div>
            </div>
           ...
           <Link to='/contact'> <button className="bg-[#0f3b66] text-white font-semibold py-3 px-6 rounded-full transition-all duration-300 flex items-center hover:bg-blue-700 text-sm">
         ...
         Contact us
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="bg-[#0f3b66] rounded-lg p-8 text-center hover:shadow-xl transition-all duration-300 col-span-1 row-span-1 flex flex-col items-center justify-center">
            ...
            <div className="bg-white rounded-lg p-6 text-center hover:shadow-xl transition-all duration-300 col-span-1 row-span-1 flex flex-col items-center justify-center border border-gray-200">
              <div className="text-[#0f3b66]-600 mb-3">
